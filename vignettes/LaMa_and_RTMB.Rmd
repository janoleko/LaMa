...
If you want to use non-standard probability distributions, check-out the `R` package [`RTMBdist`](https://janoleko.github.io/RTMBdist/) which provides a library of `AD`-compatible distributions that can be used inside likelihood functions. 
