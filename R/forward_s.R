...
#' mllk = function(theta.star, x, sizes, tol = 1e-30){
...
#'   delta = solve(t(diag(nrow(Gamma))-Gamma+1), rep(1,nrow(Gamma)), tol = tol) # stationary
#'   mu = theta.star[3:4]
...
#' mod = stats::nlm(mllk, theta.star, x = x, sizes = c(20, 30))
