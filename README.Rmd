...
* `hsmm2hmm()` and `phsmm2phmm()` for building the transition probability matrices of HSMMs,
* the `tpm()` family for computing various kinds of transition probability matrices, and 
