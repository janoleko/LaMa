...
theta.star = c(-2,-2, rep(0, 2*ncol(Z)), # starting values state process
               ...
               4, 14 ,log(3),log(5)) # starting values state-dependent process
t1 = Sys.time()
mod_np = nlm(mllk_np, theta.star, x = x, Z = Z, lambda = 50)
