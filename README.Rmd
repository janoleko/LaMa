...
The package also contains additional functions like `trigBasisExp()` for efficient computation of trigonometric link functions and `cont_tpm()` for fast calculation of transition matrices of continuous-time HMMs.
